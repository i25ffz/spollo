...
package com.spollo.player.widgets;
...
import com.spollo.player.widgets.ColorPickerView.OnColorChangedListener;
...
public class ColorSchemeDialog extends AlertDialog implements
    ...
    /*
     * (non-Javadoc)
     * @see com.spollo.player.widgets.ColorPickerView.OnColorChangedListener#
     * onColorChanged(int)
     */
    @Override
