...
import com.spollo.player.lyrics.LyricsProvider;
import com.spollo.player.lyrics.LyricsProviderFactory;
import com.spollo.player.lyrics.OfflineLyricsProvider;
...
public class LyricsFragment extends Fragment {
    ...
    private final class FetchLyrics extends AsyncTask<Boolean, Void, String> {
        ...
        protected String doInBackground(final Boolean... force) {
            ...
            if (TextUtils.isEmpty(lyrics) && ApolloUtils.isOnline(getActivity())) {
                mTryOnline = true;
